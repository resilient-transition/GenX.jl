...
@doc raw"""
	write_fusion_net_capacity_factor(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
...
"""
function write_fusion_net_capacity_factor(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
    gen = inputs["RESOURCES"]

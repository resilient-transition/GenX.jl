@doc raw"""
	write_virtual_discharge(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)
...
"""
function write_virtual_discharge(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)

...
- EP::AbstractModel: EnergyModel object.

# Results
- A CSV file named "CapacityValue.csv" is written to the directory specified by `path`.
"""
function write_capacity_value(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)
...
@doc raw"""
    capacity_reserve_margin_price(EP::AbstractModel,
                                  inputs::Dict,
                                  setup::Dict,
...
"""
function capacity_reserve_margin_price(EP::AbstractModel,
        inputs::Dict,
        setup::Dict,
        capres_zone::Int)::Vector{Float64}
    ω = inputs["omega"]

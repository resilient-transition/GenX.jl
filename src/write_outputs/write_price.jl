@doc raw"""
	write_price(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
...
"""
function write_price(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
...
@doc raw"""
	locational_marginal_price(EP::GenXModel, inputs::Dict, setup::Dict)
...
"""
function locational_marginal_price(EP::GenXModel, inputs::Dict, setup::Dict)::Matrix{Float64}
    ω = inputs["omega"]

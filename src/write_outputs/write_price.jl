@doc raw"""
	write_price(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)
...
"""
function write_price(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)
...
@doc raw"""
	locational_marginal_price(EP::AbstractModel, inputs::Dict, setup::Dict)
...
"""
function locational_marginal_price(EP::AbstractModel, inputs::Dict, setup::Dict)::Matrix{Float64}
    ω = inputs["omega"]

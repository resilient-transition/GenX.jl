@doc raw"""
	write_vre_stor(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)

Function for writing the vre-storage specific files.
"""
function write_vre_stor(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
...
@doc raw"""
	write_vre_stor_capacity(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)

Function for writing the vre-storage capacities.
"""
function write_vre_stor_capacity(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
...
@doc raw"""
	write_vre_stor_charge(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)

Function for writing the vre-storage charging decision variables/expressions.
"""
function write_vre_stor_charge(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)
    gen = inputs["RESOURCES"]
    gen_VRE_STOR = gen.VreStorage
    T = inputs["T"]
...
@doc raw"""
	write_vre_stor_discharge(path::AbstractString, inputs::Dict, setup::Dict, EP::GenXModel)

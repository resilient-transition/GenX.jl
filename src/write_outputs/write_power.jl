@doc raw"""
	write_power(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)

Function for writing the different values of power generated by the different technologies in operation.
"""
function write_power(path::AbstractString, inputs::Dict, setup::Dict, EP::AbstractModel)

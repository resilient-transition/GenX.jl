@doc raw"""
	thermal_commit!(EP::GenXModel, inputs::Dict, setup::Dict)
...
"""
function thermal_commit!(EP::GenXModel, inputs::Dict, setup::Dict)
...
@doc raw"""
	thermal_commit_operational_reserves!(EP::GenXModel, inputs::Dict)
...
"""
function thermal_commit_operational_reserves!(EP::GenXModel, inputs::Dict)
...
@doc raw"""
    maintenance_formulation_thermal_commit!(EP::GenXModel, inputs::Dict, setup::Dict)

Creates maintenance variables and constraints for thermal-commit plants.
"""
function maintenance_formulation_thermal_commit!(EP::GenXModel, inputs::Dict, setup::Dict)
...
@doc raw"""
    thermal_maintenance_capacity_reserve_margin_adjustment!(EP::GenXModel, inputs::Dict)

Eliminates the contribution of a plant to the capacity reserve margin while it is down for maintenance.
"""
function thermal_maintenance_capacity_reserve_margin_adjustment!(EP::GenXModel,
        inputs::Dict)
    gen = inputs["RESOURCES"]
...
@doc raw"""
    fusion_formulation_thermal_commit!(EP::GenXModel, inputs::Dict)

Apply fusion-core-specific constraints to the model.

"""
function fusion_formulation_thermal_commit!(EP::GenXModel, inputs::Dict, setup::Dict)

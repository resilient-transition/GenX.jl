@doc raw"""
	hydro_res!(EP::GenXModel, inputs::Dict, setup::Dict)
...
```
"""
function hydro_res!(EP::GenXModel, inputs::Dict, setup::Dict)
...
@doc raw"""
	hydro_res_operational_reserves!(EP::GenXModel, inputs::Dict)
...
```
"""
function hydro_res_operational_reserves!(EP::GenXModel, inputs::Dict)
